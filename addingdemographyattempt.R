...
##lesjustsay esnoopy form the peanits
...
Total.Humans = 2
Initial.Total.Mosquitoes = 6 #Total.Humans*3
Initial.Inf.Mosquitoes = 6*InitMosIR
...
print(TimenTemp) #make sure they're = in length
...
Human.Mosquito.SIS.SI.Model <- function(t, state, parameters) {
  ...
  with(as.list(c(state, parameters)), {
    ...
    #I'll use the temp-dependent equation to determine death rate
    birthsM <- muM * NM #let's change birth values to also be temp dependent
    #I believe I discussed possible variables for this above but
    # hatch #, egg count
